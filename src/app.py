...
def add_products():
    ...
    prod = dict()
    prod['vendor'] = req['vendor']
    prod['description'] = req['description']
    prod['alt_description'] = req['alt_description']
    prod['compartments'] = req['compartments']
    prod_list = list()
...
def add_asset():
    ...
    dat = dict()
    dat['timestamp'] = req['timestamp']
#   dat['vendor'] = req['vendor']
#   dat['description'] = req['description']
#   dat['compartments'] = req['compartments']
#   dat['facility'] = req['facility']
    dat['result'] = 'OK'
    data = json.dumps(dat)

#    SQL = "INSERT INTO assets (vendor, description,compartments,facility) VALUES (%s,%s,%s,%s)"
#    data1 = (req['vendor'],req['description'],req['compartments'],req['facility'],)
#    cursor.execute(SQL,data1)
#    conn.commit()
